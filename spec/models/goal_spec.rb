...
describe Goal do
  ...
  context 'when validating' do
    ...
    it 'is not valid with an invalid Weight' do
      ['', 'foo', -1.5].each do |invalid_weight|
        @feature.weight = invalid_weight
        @feature.should_not be_valid
      end
    end
